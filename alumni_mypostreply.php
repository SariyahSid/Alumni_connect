...
<link rel="stylesheet" href="css/alumnimypostreply.css" />
<?php
...
<center>
<h3>Click to view:</h3>
<button class="button" type="submit" name="posts">My Posts</button>
<button class="button" type="submit" name="replies">My Replies</button>
</center>
</form>
<br /><br />
