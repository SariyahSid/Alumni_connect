...
<link rel="stylesheet" href="css/add_forumpost.css"/>
	...
	else
	{
		...
		if($result->num_rows > 0) 
		{
			while($row = $result->fetch_assoc())
			{
				...
				{			
					$sql = "INSERT INTO forumdata (eforum_author, eforum_title, eforum_content,  eforum_tags) 
					VALUES('$fauthor', '$ftitle', '$fmessage',  '$ftags' )";
