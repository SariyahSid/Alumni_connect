...
if($sess!='')
  ...
  alumniinfo.pi_session,alumniinfo.pi_email ,  alumniinfo.pi_gender, alumniinfo.pi_company, alumniinfo.pi_linkedin FROM alumnimember, alumniinfo 
...
while ($row = mysqli_fetch_assoc($resultAWA))
{
    ...
    $url=$row['pi_linkedin'];
    echo "<td> <a href='{$url}'>Connect</a></td>";
	echo "</tr>";
}
?>
</table>
