...
background: linear-gradient(90deg, rgba(5,0,36,0.9587185215883228) 0%, rgba(194,30,56,1) 82%, rgba(95,4,152,1) 100%);
    position: absolute;
    height: 100%;
    width: 100%;
    z-index: -1;
...
<h1 style="padding-left:100px;color:white;"> View Alumni Membership </h1>
<br>
